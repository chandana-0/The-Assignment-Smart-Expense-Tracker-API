...
We use Pydantic (which FastAPI is built on) to define the *shape* of an
expense. FastAPI automatically validates incoming JSON against these models
and returns a clean 422 error if something is missing or the wrong type —
