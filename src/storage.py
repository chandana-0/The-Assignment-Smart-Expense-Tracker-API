...
Kept separate from the API routing code (main.py) on purpose:
- Easier to test in isolation (no HTTP layer involved)
- Easier to swap for a JSON file or real database later without
